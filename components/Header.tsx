...
function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row items-center md:items-start md:space-x-6 px-2 py-10 pb-5 md:p-10 md:pb-5">
      <Link href="/">
        <Image
      ...
      {/* sort_by */}
      <div className="items-center w-full md:max-w-2xl">
        <form
          action={(formData) => {
          ...
          className=""
        >
          <div className="flex items-center gap-2 w-full px-4 flex-1">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 max-w-lg md:max-w-none mx-auto items-center gap-2 p-4">
            <SearchSelect
